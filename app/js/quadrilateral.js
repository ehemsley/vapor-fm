let Quadrilateral;
module.exports = (Quadrilateral = class Quadrilateral {
  constructor(mystifyQuadrilateral, vertices, velocities, bounds) {
    ...
    const width = Math.abs(this.leftBound - this.rightBound);
    const height = Math.abs(this.topBound - this.bottomBound);
