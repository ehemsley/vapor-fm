...
module.exports = class RenderController {
  constructor (audioInitializer) {
    ...
    this.visualizerElement = document.getElementById('visualizer') // $('#visualizer')
  ...
  ClearLogo () {
    const minDimension = Math.min(this.canvas1.width * 0.12, this.canvas1.height * 0.12)
    return this.context1.clearRect((this.canvas1.width * 0.98) - minDimension,
      (this.canvas1.height * 0.98) - minDimension,
      minDimension,
      minDimension)
  }
  ...
  DrawLogo () {
    ...
    this.context1.drawImage(img,
      (this.canvas1.width * 0.98) - minDimension,
      (this.canvas1.height * 0.98) - minDimension,
      minDimension,
      minDimension)
