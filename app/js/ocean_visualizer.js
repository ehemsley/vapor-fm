...
module.exports = (OceanVisualizer = class OceanVisualizer extends Visualizer {
  ...
  InitWaterBox() {
    const geometry = new THREE.BoxGeometry(500, 500, 10);
    ...
    loader.load('models/dolphin.obj', object => {
      object.traverse(function(child) {
        if (child instanceof THREE.Mesh) {
          return child.material = dolphinMaterial;
        }
      });
          ...
          if (this.audioInitializer.beatdetect.isSnare()) {
            ...
            const skyboxTween =
              new TWEEN.Tween(this.skyBox.material.color)
                ...
                .start()
                .onUpdate(() => {
                  return this.skyBox.material.needsUpdate = true;
              });
            ...
            const sunTween =
              new TWEEN.Tween(this.sun.material.color)
                ...
                .start()
                .onUpdate(() => {
                  return this.sun.material.needsUpdate = true;
              });
